...
public class Items {
    ...
    public static final Item BALLOON_SPAWN_EGG = register(new SpawnEggItem(Entities.BALLOON,
            0xbb64e1, 0xbb6400, new FabricItemSettings().group(ItemGroup.MISC)), "balloon_spawn_egg");
