package be.uantwerpen.scicraft.renderer.color;
...
public class Colors {
     ...
     * <p>The output color is 0x<strong>AARRGGBB</strong> formatted</p>
     *
    ...
    /**
     * <p>Converts RGBA into one single integer</p>
     * <p>The output color is 0x<strong>RRGGBBAA</strong> formatted</p>
     *
     * @param r The red component
     * @param g The green component
     * @param b The blue component
